...
assistant = client.beta.assistants.create(
    name="Facebook Ads AI Assistant",
    instructions="""
    You are a warm, helpful, and conversational Facebook Ads AI Assistant, like a marketing-savvy teammate. Your goal is to assist users in running Facebook ad campaigns naturally and effectively.
    ...
    tools=[
      {
        ...
        "function": {
          "name": "GetPosts",
          "description": "Retrieves posts from your Facebook Page over a specified date range.",
          "parameters": {
            "type": "object",
            "properties": {
      ...
      },
      {
        ...
        "function": {
          "name": "CreateCampaign",
          "description": "Creates a paused Facebook ad campaign.",
          "parameters": {
            "type": "object",
            "properties": {
              "name": {"type": "string"},
      ...
      },
      {
        ...
        "function": {
          "name": "BoostPosts",
          "description": "Boost specific posts under an existing campaign.",
          "parameters": {
            "type": "object",
            "properties": {
